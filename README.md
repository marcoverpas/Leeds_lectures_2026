...
A more detailed introduction to SFC models, including comparisons with other types of models and discussions of alternative software options, is available [here](https://github.com/marcoverpas/PhD_Lectures_Macerata_2025#b1_introduction_to_sfc_models).
...
<figure>
<img
src="https://github.com/marcoverpas/figures/blob/main/pc_sd.gif" width="820">
</figure>
...
>
> Click the link below to open the simulation laboratory for *Model PC*. 
>  
...
> </div>
> <br><br>
> Please wait a few moments while the simulation loads. :hourglass_flowing_sand:
...
>
> Click the link below to open the simulation laboratory for *Model BMW*. 
>  
...
> ### 📦 Box E - Playing with Model ECO-3IO-PC
>
> Not only can these models be made interactive, but they can also be conveniently extended to include a variety of variables. Here you can explore an ecosystem-extended version of Model IO-PC.
>  
