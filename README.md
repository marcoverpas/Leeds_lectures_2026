...
<sub><i>A "mathematical monster": a few lines of code yield an elaborate, lifelike form that means absolutely nothing. Complexity is easy, economic meaning is the hard part. (Adapted from an original generative-art snippet by <a href="https://x.com/yuruyurau">@yuruyurau</a></i></sub>)
</div>
